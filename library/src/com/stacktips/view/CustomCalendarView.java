...
public class CustomCalendarView extends LinearLayout {
    ...
    private Drawable selectedDayBackgroundDrawable;
    private Drawable dayOfWeekBackgroundDrawable;
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        dayOfWeekBackgroundDrawable = typedArray.getDrawable(R.styleable.CustomCalendarView_dayOfWeekBackgroundDrawable);
        selectedDayBackgroundDrawable = typedArray.getDrawable(R.styleable.CustomCalendarView_selectedDayBackgroundDrawable);
    ...
    public void markDayAsCurrentDay(Calendar calendar) {
        if (calendar != null && CalendarUtils.isToday(calendar)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                dayOfMonth.setBackground(dayOfWeekBackgroundDrawable);
//                dayOfMonth.setPadding(0,40,0,0);
            }
        }
    }
    ...
    public void markDayAsSelectedDay(Date currentDate) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            view.setBackground(selectedDayBackgroundDrawable);
        }
    }
